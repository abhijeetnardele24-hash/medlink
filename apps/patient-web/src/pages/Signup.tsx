...
import { HeartPulse, Lock, Mail, AlertCircle, User, Phone } from 'lucide-react';
...
export const Signup: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Register Patient via Backend
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-base)', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem' }}>
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>Join MedLink to connect with doctors</p>
        </div>

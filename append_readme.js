...
1. **Porting, not rewriting:** The existing PharmacyCatalog and checkout logic currently in \pps/pharmacy-web/src/App.tsx\ will be explicitly ported to \pps/patient-web\. This logic is already tested and handles Rx-gating, so it will be reused instead of rebuilt from scratch.
